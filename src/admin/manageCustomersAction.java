...
import admin_dao.CustomersHibDao;
...
/**
 * An object of the CustomersHibDao class to service data operation requests such as Insert, Update, Delete, View.
 ...
 * This List object will be populated by the view() method with the records available in the Customers table.
 ...
 * This list will be made available to the JSP page for displaying customer details data grid.
 ...
 * This list will be made available to the JSP page for displaying customer details data grid.
 * @param customers A list object of Customers.
 */
...
/**
 * update() method is invoked when a user keys in the desired data and clicks Save.
 * It performs an update operation [using DAO object's update() method].
 ...
 * It populates the List object [customers] created earlier which will be used in the JSP page's <s:iterator> tag to form the data grid.
 * This data grid displays existing records from the Customers table.
 ...
 * The delete operation is performed by invoking the DAO object's getCustomerNo() method.
 * getCustomerNo() method is passed the CustomerNo which is made available by the JSP page using <s:param> on click of X.
 * @SkipValidation is used to skip validation for this method.
 */
    @SkipValidation
 ...
 * The data is retrieved using the DAO object's edit() method which is passed the chosen record's CustomerNo.
 * CustomerNo is made available by the JSP page's <s:param> tag on click of the record.
