...
import admin_dao.PublishersHibDao;
...
/**
 * An object of the PublishersHibDao class to service data operation requests such as Insert, Update, Delete, View.
 ...
 * This list will be made available to the JSP page for displaying publisher details data grid.
 ...
 * It performs an update operation [using DAO object's update() method] if the publisher.PublisherNo holds a valid Publisher No.
 * It performs an insert operation [using DAO object's insert() method] if the publisher.PublisherNo is empty.
 * The captured form data is passed to the DAO object's methods using the parameterized constructor of the Publishers bean class.
 */
 ...
 * It populates the List object [publishers] created earlier which will be used in the JSP page's <s:iterator> tag to form the data grid.
 ...
 * The delete operation is performed by invoking the DAO object's getPublisherNo() method.
 * getPublisherNo() method is passed the PublisherNo which is made available by the JSP page using <s:param> on click of X.
 * @SkipValidation is used to skip validation for this method.
 */
    @SkipValidation
 ...
 * The data is retrieved using the DAO object's edit() method which is passed the chosen record's PublisherNo.
 * PublisherNo is made available by the JSP page's <s:param> tag on click of the record.
